              ...
              <Grid container className={classes.leftContainer}>
                <Grid item md={6} sm={6} className={classes.iconsGrid}>
                  <Link
                    ...
                    href="https://github.com/AparnaSarawadekar"
                    target="_blank"
                  ...
                  <Link
                    className={classes.socialItem}
                    href="https://www.linkedin.com/in/aparna-sarawadekar/"
                    target="_blank"
                    rel="noopener noreferrer"
                    color="inherit"
                  >
                  ...
                  <Link
                    className={classes.socialItem}
                    href="mailto:asara068@ucr.edu"
                    target="_blank"
                    rel="noopener noreferrer"
                    color="inherit"
                  >
                    <MailIcon fontSize="large" className={classes.icon} />
                    <Typography>asara068@ucr.edu</Typography>
                  </Link>
                </Grid>
